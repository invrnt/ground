# Submission copy and pending rules
...
No event portal URL, account or rules were supplied. Categories, eligibility, prior-code rules, submission deadline, licenses, evaluator access requirements and upload fields are therefore unverified. The 120-second limit here comes from the PRD, not a claimed event rule. Do not claim a sponsor prize or eligibility until the actual portal is checked.
