...
export const normalizedMessageSchema=z.object({provider:z.enum(['telegram','slack']),update_id:z.string(),chat_id:z.string(),message_id:z.string(),sender_id:z.string(),text:z.string().nullable(),sent_at:timestampSchema,received_at:timestampSchema,reply_to_message_id:z.string().nullable(),media:z.array(mediaDescriptorSchema),project_id:idSchema,run_id:idSchema}).strict();
