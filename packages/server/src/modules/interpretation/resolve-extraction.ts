import { z } from 'zod';
import { operationProposalSchema, GroundError, type OperationProposal, type ProjectSnapshot } from '@ground/contracts';
...
export function resolveCommand(command:Extraction['commands'][number],context:ProjectSnapshot,evidence_ids:string[],document_hash:string|null,newIssue:string|null):OperationProposal {
